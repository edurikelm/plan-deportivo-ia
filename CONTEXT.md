...
- **Guardar con etiqueta** — acción explícita del coach. Abre un form inline con campos `Ejercicio` (obligatorio) y `Repeticiones` (obligatorio, entero ≥ 1, default 1, default sube a 5 si el último set del mismo ejercicio fue > 1). Persiste un `SavedWeightRecord` con `source: "manual"`.
